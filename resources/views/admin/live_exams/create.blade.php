                    ...
                    <form action="{{ route('admin.live-exams.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="duration_minutes" value="{{ old('duration_minutes', 30) }}" required min="1" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
