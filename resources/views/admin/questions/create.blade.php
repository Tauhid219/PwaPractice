                    ...
                    <form action="{{ route('admin.questions.store') }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                            <div>
                                ...
                                <input type="text" name="option_1" id="option_1" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required placeholder="Option 1">
                            </div>
                            <div>
                                <label for="option_2" class="block text-gray-700 text-sm font-bold mb-2">Option 2</label>
                                <input type="text" name="option_2" id="option_2" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required placeholder="Option 2">
                            </div>
                            <div>
                                <label for="option_3" class="block text-gray-700 text-sm font-bold mb-2">Option 3</label>
                                <input type="text" name="option_3" id="option_3" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required placeholder="Option 3">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="answer_text" id="answer_text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required placeholder="Correct Answer">
                        </div>
