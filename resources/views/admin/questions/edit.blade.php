            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form action="{{ route('admin.questions.update', $question->id) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="answer_text" class="block text-gray-700 text-sm font-bold mb-2">Answer</label>
                            <textarea name="answer_text" id="answer_text" rows="2" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>{{ $question->answer_text }}</textarea>
                        </div>
